...
module.exports = {
    ...
    run: (botxi, message, args) => {
        ...
        const emHelp = new MessageEmbed()
            ...
            .addField("Comandos de Acción", '▔▔▔▔▔▔▔▔▔▔▔▔', true)
            .addField("-> `" + prefix + "galleta`", ":: Da una galleta a un usuario. \nPor ejemplo: *" + prefix + "galleta <@usuario>*")
            .addField("-> `" + prefix + "run`", ":: Salir a correr.")
            .addField("-> `" + prefix + "kiss`", ":: Da un beso a un usuario. \nPor ejemplo: *" + prefix + "kiss <@usuario>* \n")
