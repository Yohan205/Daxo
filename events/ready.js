import { countFiles, memoryUsedRAM } from "fulnode.js";
...
module.exports = {
  ...
  run: async (botxi, args, BOT) => {
    ...
    console.info(
      BOT.console.info +
        `Memoria RAM usada ${memoryUsedRAM().usedByProcess} y la memoria libre es ${memoryUsedRAM().free} de ${memoryUsedRAM().max}`,
    );
    console.log(
      BOT.console.info +
        `Conectado en ${botxi.guilds.cache.size} servidores y ${botxi.users.cache.size} usuarios con ${cantidadComandos} comandos`,
    );
  },
};
