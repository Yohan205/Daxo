...
router.get("/", async (req, res) => {
  res.render("home", {
    title: "Inicio",
    descPag:
      "En HiDaxo tenemos una gran variedad de contenido, todo depende de ti lo que quieras encontrar.",
...
router.get("/testjs", checkAuth, async (req, res) => {
  ...
  /*const URI1 = `https://keep.googleapis.com/v1/notes`;
...
router.get("/otros/comandos-de-voz-google", (req, res) => {
  res.render("CmdsGoogle", {
    ...
    descPag:
      "Aquí podrás ver los comandos de voz más comunes para que uses al asistente de google",
    keywordsPag:
      "comandos de voz, google assistant, asistente de google, google, hablar con google",
  });
});
